  ...
  const getAvailableSlots = async () => {
    ...
    for (let i = 0; i <= 7; i++) {
      ...
      while (currentDate < endTIme) {
        ...
        // Increnment current timeby 30 minute
    ...
    docInfo && (
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
            ...
            {docSlots.length &&
              docSlots.map((item, index) => (
                <div
                  ...
                  className={`text-center py-7 w-[4rem] rounded-full cursor-pointer ${
          ...
          <button className="capitalize bg-primary text-white text-sm font-light px-14 py-3 rounded-full my-6">
            book an appointment
          </button>
        </div>
